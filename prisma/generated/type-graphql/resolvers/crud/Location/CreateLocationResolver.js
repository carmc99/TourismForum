...
exports.CreateLocationResolver = void 0;
...
let CreateLocationResolver = class CreateLocationResolver {
...
], CreateLocationResolver.prototype, "createLocation", null);
CreateLocationResolver = tslib_1.__decorate([
    TypeGraphQL.Resolver(_of => Location_1.Location)
], CreateLocationResolver);
exports.CreateLocationResolver = CreateLocationResolver;
